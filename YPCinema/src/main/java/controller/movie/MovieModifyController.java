...
public class MovieModifyController {
	...
	public String movieModifyAction(@RequestParam("num") String movie_num, MovieCommand movieCommand, Model model) {
//		movieModifyService.selectByMovieNum(movie_num, model);
