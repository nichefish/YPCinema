...
<title>Staff_nav</title>
 ...
 <style>
    ...
    background-image: linear-gradient(180deg,#8fa48a 10%,#0077a4 100%);
	...
	<div id="wrapper">
		...
		<!-- 사이드바 브랜드 -->
			...
			<li class="nav-item active"><a class="nav-link"
				href="staff_se"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>Gnte 근태</span></a>
			</li>
			<!-- Divider -->
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapseTwo"> <i
					class="fas fa-fw fa-cog"></i> <span>Only Staff &nbsp;<small></small></span>
			</a>
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">only Staff</h6>
						<a class="collapse-item" href="staff_se">근태관리</a> <a
							class="collapse-item" href="staff_myContracts">나의 계약서</a> 
