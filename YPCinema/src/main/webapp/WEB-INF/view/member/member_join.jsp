			...
			<div class="relCon" align="center">
				...
				<thead>
				 	...
				 	<tr>
				 		...
				 		<td width="400">
				 			<form:password path="m_pass" id="m_pass" size="14" maxlength="10" /><br />
				 	...
				 	<tr>
				 		...
				 		<td width="400">
				 			<form:password path="m_pass_con" id="m_pass_con" size="14" maxlength="10" /><br />
...
$(function() {
	$("#frm").submit(function() {
		if ($("#m_pass").val() != $("#m_pass_con").val()) {
			alert("비밀번호 입력값과 비밀번호 확인 입력값이 일치하지 않습니다.");
			$("#m_pass").val("");
			$("#m_pass_con").val("");
			$("#m_pass").focus();
			return false;
