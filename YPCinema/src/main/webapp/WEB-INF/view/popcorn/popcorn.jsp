                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="popcorn">매점</a>
                                        <a class="dropdown-item" href="regular-page.html">직원관리</a>
                    ...
                    <div class="post-content-area mb-50">
                        ...
                        <div class="world-catagory-area">
                            <ul class="nav nav-tabs" id="myTab" role="tablist" style="width:930px">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="tab6" data-toggle="tab" href="#world-tab-6" role="tab" aria-controls="world-tab-6" aria-selected="false">핫도그</a>
                                </li>

                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">치킨</a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="single-blog-post post-style-2 d-flex align-items-center" style="height:200px">
                                                ...
                                                <div class="post-content">
                                                    ...
                                                    <!-- Post Meta -->
                                                  <div class="post-meta">
                                                        <p> <a href="#" class="post-date"><h5>옥수수 본연의 맛. 클래식 고소팝콘!</h5></a></p>
                                                    </div>
                                                </div>
                                            </div>
                                              <div class="single-blog-post post-style-2 d-flex align-items-center" style="height:200px">
                                                ...
                                                <div class="post-content">
                                                    ...
                                                    <!-- Post Meta -->
                                                    <div class="post-meta">
                                                        <p> <a href="#" class="post-date">달콤한 카라멜 향이 가득한 달콤팝콘!</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                              <div class="single-blog-post post-style-2 d-flex align-items-center"  style="height:200px">
                                                ...
                                                <div class="post-content">
                                                    ...
                                                    <!-- Post Meta -->
                                                    <div class="post-meta">
                                                        <p><a href="#" class="post-date">치즈매니아들이라면 치즈팝콘!</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                              <div class="single-blog-post post-style-2 d-flex align-items-center"  style="height:200px">
                                                ...
                                                <div class="post-content">
                                                    ...
                                                    <!-- Post Meta -->
                                                    <div class="post-meta">
                                                        <p><a href="#" class="post-date">중독성 200%. 어니언팝콘!</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="single-blog-post post-style-2 d-flex align-items-center"  style="height:200px">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                    <img src="img/blog-img/popcorn5.jpg" alt="">
                                                </div>
                                                <!-- Post Content -->
                                                <div class="post-content">
                                                    <a href="#" class="headline">
                                                    ...
                                                    <!-- Post Meta -->
                                                    <div class="post-meta">
                                                        <p><a href="#" class="post-date">옥수수 본연의 맛. 클래식 고소팝콘!</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="single-blog-post post-style-2 d-flex align-items-center"  style="height:200px">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                    <img src="img/blog-img/popcorn6.jpg" alt="">
                                                </div>
                                                <!-- Post Content -->
                                                <div class="post-content">
                                                    <a href="#" class="headline">
                                            ...
                                            <!-- Single Blog Post -->
                                            <div class="single-blog-post post-style-2 d-flex align-items-center"  style="height:150px">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                    <img src="img/blog-img/popcorn7.jpg" alt="">
                                                </div>
                                                <!-- Post Content -->
                                                <div class="post-content">
                                                    <a href="#" class="headline">
                                            ...
                                            <div class="single-blog-post post-style-2 d-flex align-items-center"  style="height:150px">
                                                <!-- Post Thumbnail -->
                                                <div class="post-thumbnail">
                                                    <img src="img/blog-img/popcorn8.jpg" alt="">
                                                </div>
                                                <!-- Post Content -->
                                                <div class="post-content">
                                                    <a href="#" class="headline">
