				...
				<div class="xans-element- xans-product xans-product-detail">
					...
					<div class="detailArea">
						<div
							...
							<div class="keyImg">
								<div class="thumbnail">
									<img src="partner/update/${partnerGoods.partnerGoodsImage}" />
								</div>
							</div>
						</div>
						<div class="infoArea">
							<div class="detail_title ">${partnerGoods.partnerGoodsName }</div>
									...
									<tbody>
										<tr class=" xans-record-">
											...
											<td><span style="font-size: 18px;"> <strong
													id="span_product_price_text">${partnerGoods.partnerGoodsPrice }&nbsp;원
												</strong> <input id="product_price" name="product_price"
													type="hidden" /></span></td>
										</tr>
										<tr class=" xans-record-">
											<th scope="row"><span style="font-size: 15px;">굿즈간략설명</span></th>
											<td><span style="font-size: 15px;">${partnerGoods.partnerGoodsPrice }</span></td>
										</tr>
									</tbody>
								</table>
							</div>
							...
							<div class="xans-element- xans-product xans-product-action ">
								...
								<a href="cartAdd?num=${partnerGoods.partnerGoodsNum }" class="bt_cart"> 장바구니</a>
								<a href="order?num=${partnerGoods.partnerGoodsNum }" class=" bt_order">구매하기</a>
							</div>
						</div>
					</div>
				</div>
