                    ...
                    <div class="post-content-area mb-50">
                        ...
                        <div class="world-catagory-area">
                            <ul class="nav nav-tabs" id="myTab" role="tablist" style="width:930px">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="tab1" data-toggle="tab" href="partnerGoodsMenutype?type=all" role="tab" aria-controls="world-tab-1" aria-selected="true">All</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="partnerGoodsMenutype?type=굿즈 카드" role="tab">카드</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="partnerGoodsMenutype?type=캐릭터" role="tab" >캐릭터</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="partnerGoodsMenutype?type=학용품" role="tab">학용품</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="partnerGoodsMenutype?type=식기류" role="tab" >식기류</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="partnerGoodsMenutype?type=전제제품" role="tab">전자제품</a>
                                </li>
                                    <li class="nav-item">
                                    <a class="nav-link"  data-toggle="tab" href="partnerGoodsMenutype?type=잡화" role="tab">잡화</a>
                                </li>
                            </ul>
