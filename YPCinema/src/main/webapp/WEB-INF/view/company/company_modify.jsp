...
<div class="main-content-wrapper section-padding-100">
 	<div class="container" align="center">
		<form:form name="frm" id="frm" method="POST" enctype="multipart/form-data" commandName="companyCommand">
			...
			<table width="600" align="center" border=1 >
				<tr rowspan="2">
			 	...
			 	<tr>
			 		...
			 		<td width="400">
			 			<form:input path="c_name" id="userName" size="12" maxlength="10" />
				...
				<tr>
					...
					<td width = 400 >
						<form:input path="c_ph" id="userPh1" size="30" maxlength="28" />
						<form:errors path="c_ph" />
					</td>
				</tr>
			 	<tr>
				...
				<tr>
					<td>우편번호 </td>
					<td><form:hidden path="c_zip" id="c_zip" /><input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><input type="text" id="m_zip_show" placeholder="우편번호" value="${companyCommand.c_zip}" disabled /></td>	
				</tr>
				<tr>
					<td>주소 </td>
					<td>
						<form:hidden path="c_addr1" id="c_addr1" /><input type="text" id="c_addr1_show" style="width:99%;" placeholder="도로명주소" value="${companyCommand.c_addr1}" disabled="disabled" /><br/>
						<form:input path="c_addr2" id="c_addr2" style="width:75%;" placeholder="상세주소"/>
					</td>
				</tr>
				<tr>
					<td>회원등급</td>
...
function sample4_execDaumPostcode() {
	new daum.Postcode(
	{
		oncomplete : function(data) {
			...
			document.getElementById("c_addr1").value = roadAddr;
			document.getElementById("c_addr1_show").value = roadAddr;
		}
	}).open();
}
</script>
