						...
						<div class="card-body" >
							...
							<form method="post">
								<table class="table table-bordered" id="dataTable" cellspacing="0">
									...
									<tr>
										<td>Theater Name</td>
										<td><input type="text" name="theater_name"	id="theater_name" ></td>
									</tr>
									<tr>
										<td>Postal Code</td>
										<td>
									...
									<tr>
										...
										<td><input type="text" name="theater_addr2" id="theater_addr2"  ></td>
									</tr>
									<tr>
										<td>Phone Number</td>
										<td><input type="text" name="theater_ph" id="theater_ph" ></td>
									</tr>
