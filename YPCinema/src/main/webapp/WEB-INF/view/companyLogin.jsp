...
<div class="main-content-wrapper section-padding-100">
 	<div class="container" align="center">
		<form:form action="companyLogin" name="frm" id="frm" method="POST" commandName="companyLoginCommand">
			<table border="1">
				<tr>
				...
				<tr>
					<td colspan="3" align="right">
						<a href="#">아이디 찾기</a>
						<a href="#">비밀번호 찾기</a>
						<a href="companyRegister">회원가입</a>
					</td>
				</tr>
			</table>
		</form:form>
		현재 ID: <c:out value="${companyAuthInfo.id}" />
	</div>
</div>
</c:if>
